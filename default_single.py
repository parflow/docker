...
dsingle = Run("default_single", __file__)
...
dsingle.Process.Topology.P = int(sys.argv[1])
dsingle.Process.Topology.Q = int(sys.argv[2])
dsingle.Process.Topology.R = int(sys.argv[3])
